...
export const setAccountTenders = (contractorTenders: Array<Tender>): SetAccountTenders => ({
  type: SET_CONTRACTOR_TENDERS,
  contractorTenders
})
export const setMyRepliesList = (allRequests: Array<TenderRequest>): SetMyRepliesList => ({type: SET_MY_REPLIES, allRequests})
export const setUser = (user: User): SetUser => ({type: SET_USER, user})
